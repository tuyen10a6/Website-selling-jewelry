...
using System.Text;
using static DAL.Helper.DatabaseHelper;
...
namespace DAL.Helper
{
    ...
    public interface IDatabaseHelper
    {
        ...
        SqlResult ExecuteSProcedureReturnDataTables(string sprocedureName, params object[] paramObjects);
        /// <summary>
        ...
        DataTable ExecuteSProcedureReturnDataTable( string sprocedureName, params object[] paramObjects);
        /// <summary>
