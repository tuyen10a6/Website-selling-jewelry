...
namespace DAL.Helper
{
    public class DatabaseHelper : IDatabaseHelper
    {
        ...
        public SqlResult ExecuteSProcedureReturnDataTables(string sprocedureName, params object[] paramObjects)
        {
        ...
        public DataTable ExecuteSProcedureReturnDataTable( string sprocedureName, params object[] paramObjects)
        {
            ...
            {
                tb = null;
              string   msgError = exception.ToString();
            }
            return tb;
        }
        /// <summary>
